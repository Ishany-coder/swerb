...
public class Swerb extends RobotDrive {
    private final SwerbModule[] modules = new SwerbModule[4];
     ...
     */
    public Swerb(double trackWidth, double wheelBase, double maxSpeed, PIDFCoefficients swervoPIDFCoefficients, MotorEx[] motors, CRServoEx[] swervos) {
        ...
        this.modules[0] = new SwerbModule(motors[0], swervos[0], new Vector2d(trackWidth / 2, wheelBase / 2), maxSpeed, swervoPIDFCoefficients);
        this.modules[1] = new SwerbModule(motors[1], swervos[1], new Vector2d(-trackWidth / 2, wheelBase / 2), maxSpeed, swervoPIDFCoefficients);
        this.modules[2] = new SwerbModule(motors[2], swervos[2], new Vector2d(-trackWidth / 2, -wheelBase / 2), maxSpeed, swervoPIDFCoefficients);
        this.modules[3] = new SwerbModule(motors[3], swervos[3], new Vector2d(trackWidth / 2, -wheelBase / 2), maxSpeed, swervoPIDFCoefficients);
    }
     ...
     */
    public Swerb setCachingTolerance(double motorCachingTolerance, double swervoCachingTolerance) {
        for (SwerbModule module : modules) {
