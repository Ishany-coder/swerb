...
public class SwerbModule {
     ...
     */
    public SwerbModule(MotorEx motor, CRServoEx swervo, Vector2d offset, double maxSpeed, PIDFCoefficients swervoPIDFCoefficients) {
        this.motor = motor;
        this.swervo = swervo;
     ...
     */
    public SwerbModule setCachingTolerance(double motorCachingTolerance, double swervoCachingTolerance) {
